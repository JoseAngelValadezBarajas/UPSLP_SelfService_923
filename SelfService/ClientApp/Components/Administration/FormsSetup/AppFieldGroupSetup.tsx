...
// #region Types
export interface IAppFieldGroupSetupProps {
...
type PropsWithStyles = IAppFieldGroupSetupProps & WithStyles<typeof styles>;
// #endregion Types

// #region Component
const AppFieldGroupSetup: React.FC<PropsWithStyles> = (props: PropsWithStyles): JSX.Element => {
    const {
        availableCountries,
        availableGridSize,
        classes,
...
// Export: Component
export default withStyles(styles)(AppFieldGroupSetup);