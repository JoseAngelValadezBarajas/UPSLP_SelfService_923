...
import InqFieldGroupSetup from './InqFieldGroupSetup';
...
import { IInquirySetupResources } from '../../../Types/Resources/Administration/IInquirySetupResources';
...
interface IInquirySetupState {
    ...
    resources?: IInquirySetupResources;
}
// #endregion Types

// #region Component
class InquirySetupView extends React.Component<any, IInquirySetupState> {
    private idModule: string;
    private idPage: string;

    public readonly state: Readonly<IInquirySetupState>;
    ...
    private getInitialState(): IInquirySetupState {
        let resources: IInquirySetupResources | undefined;
        if (this.state) {
    ...
    private onSaveAppNameSetup = (): void => {
        try {
            ...
            if (!layoutName) {
                ...
                RequestLayout.postLayoutNameExists(layoutName.trimRight(), 1,
            ...
            if (isValid) {
                if (fields && fieldIdToEdit) {
                    ...
                    if (fieldNumber > -1) {
                        ...
                        if (selectedDefault) {
                            fields[fieldNumber].default = selectedDefault.toString();
                        }
                        this.setState({
                            fieldIdToEdit: undefined,
                            fields: fields,
    ...
    private onSaveLayout = (): void => {
        try {
            ...
            if (appForm) {
                RequestLayout.postSaveLayout(appForm, 1, this.resolveSaveLayout, this.logError);
            }
        }
        catch (e) {
    ...
    // #region Function
    private getAvailableColors(resources: IInquirySetupResources):
        IDropDownOption[] {
        const options: IDropDownOption[] = [];
        try {
            ...
            option = {
                description:
                    resources.inqTextSetupResources.lblDefault,
                value: 'default'
            };
            options.push(option);
            option = {
                description:
                    resources.inqTextSetupResources.lblError,
                value: 'error'
            };
            options.push(option);
            option = {
                description:
                    resources.inqTextSetupResources.lblPrimary,
                value: 'primary'
            };
            options.push(option);
            option = {
                description:
                    resources.inqTextSetupResources.lblSecondary,
                value: 'secondary'
            };
            options.push(option);
        }
    ...
    private getAvailableComponents(resources: IInquirySetupResources):
        IDropDownOption[] {
        const options: IDropDownOption[] = [];
        try {
            let option: IDropDownOption;
            option = {
                description:
                    resources.inqAddComponentModalResources.lblImage,
                value: 'Image'
            };
            options.push(option);
            option = {
                description:
                    resources.inqAddComponentModalResources.lblDivider,
                value: 'Divider'
            };
            options.push(option);
            option = {
                description:
                    resources.inqAddComponentModalResources.lblText,
                value: 'Text'
            };
            options.push(option);
            option = {
                description:
                    resources.inqAddComponentModalResources.lblEmailLink,
                value: 'IconLinkEmail'
            };
            options.push(option);
            option = {
                description:
                    resources.inqAddComponentModalResources.lblPhoneLink,
                value: 'IconLinkPhone'
            };
            options.push(option);
            option = {
                description:
                    resources.inqAddComponentModalResources.lblButton,
                value: 'Button'
            };
            options.push(option);
            option = {
                description:
                    resources.inqAddComponentModalResources.lblUserDefined,
                value: 'UserDefined'
            };
            options.push(option);
            option = {
                description:
                    resources.inqAddComponentModalResources.lblHtmlElement,
                value: 'HtmlElement'
            };
            options.push(option);
        }
    ...
    private getAvailableTextSizes(resources: IInquirySetupResources):
        IDropDownOption[] {
        const options: IDropDownOption[] = [];
        try {
            let option: IDropDownOption;
            ...
            option = {
                description:
                    resources.inqTextSetupResources.lblH1,
                value: 'h1'
            };
            options.push(option);
            option = {
                description:
                    resources.inqTextSetupResources.lblH2,
                value: 'h2'
            };
            options.push(option);
            option = {
                description:
                    resources.inqTextSetupResources.lblH3,
                value: 'h3'
            };
            options.push(option);
            option = {
                description:
                    resources.inqTextSetupResources.lblH4,
                value: 'h4'
            };
            options.push(option);
        }
    ...
    private getAvailableTypes(resources: IInquirySetupResources):
        IDropDownOption[] {
        const options: IDropDownOption[] = [];
        try {
            let option: IDropDownOption = {
                description: resources.inqUserDefinedSetupResources.lblCheckbox,
                value: 'Checkbox'
            };
            options.push(option);
            option = {
                description: resources.inqUserDefinedSetupResources.lblDropdown,
                value: 'Dropdown'
            };
            options.push(option);
            option = {
                description: resources.inqUserDefinedSetupResources.lblTextField,
                value: 'TextField'
            };
            options.push(option);
            option = {
                description: resources.inqUserDefinedSetupResources.lblDatePicker,
                value: 'DatePicker'
            };
            options.push(option);
        }
    ...
    private getAvailablesGridSizes(resources: IInquirySetupResources):
        IDropDownOption[] {
        const options: IDropDownOption[] = [];
        try {
            let option: IDropDownOption = {
                description: resources.inqFieldGroupSetupResources.lblExtraSmall,
                value: 'XS'
            };
            options.push(option);
            option = {
                description: resources.inqFieldGroupSetupResources.lblSmall,
                value: 'S'
            };
            options.push(option);
            option = {
                description: resources.inqFieldGroupSetupResources.lblMedium,
                value: 'M'
            };
            options.push(option);
            option = {
                description: resources.inqFieldGroupSetupResources.lblLarge,
                value: 'L'
            };
            options.push(option);
            option = {
                description: resources.inqFieldGroupSetupResources.lblExtraLarge,
                value: 'XL'
            };
            options.push(option);
        }
            ...
            if (resources) {
                ...
                if (hdnLayoutId && hdnLayoutId.value) {
                    ...
                    if (Number(hdnLayoutId.value) === 1) {
                        RequestLayout.getFormLayoutDefault(1, this.resolveGetLayout, this.logError);
                    }
                    else {
    ...
    private onLayoutReady = (): void => {
        ...
        const resources: IInquirySetupResources | undefined = LayoutStore.getResources();
    ...
    public render(): JSX.Element {
        ...
        if (!componentError && resources) {
            ...
            if (openNameSetupModal) {
                appNameSetup = (
                    <AppNameSetup
                        ...
                        resources={resources.inqNameSetupResources}
                    />
                );
            }
            ...
            if (openSendToModal && availableSteps && fieldGroupId) {
                sendToModal = (
                    <AppSendToModal
                        ...
                        resources={resources.inqSendToModalResources}
            ...
            if (openStepSetupModal) {
                setupStepModal = (
                    <AppSetupStepModal
                        ...
                        resources={resources.inqSetupStepModalResources}
                    />
                );
            }
            ...
            if (openFieldGroupModal && availableGridSizes && fieldGroupId) {
                setupFieldGroup = (
                    <InqFieldGroupSetup
                        ...
                        resources={resources.inqFieldGroupSetupResources}
                    />
                );
            }
            ...
            if (openAddComponet && availableComponents && availableDataTypes && availableTypes
                ...
                addComponent = (
                    <AppAddComponentModal
                        ...
                        resources={resources.inqAddComponentModalResources}
                        resourcesExtraComponentsSetup={resources.inqExtraComponentSetupResources}
                        resourcesTextSetup={resources.inqTextSetupResources}
                        resourcesAppUserDefined={resources.inqUserDefinedSetupResources}
                    />
                );
            }
            ...
            if (openAddOption) {
                addOptions = (
                    <AppAddOptionsModal
                        ...
                        resources={resources.inqAddOptionsModalResources}
                    />
                );
            }
            ...
            if (openConfirmationRemove) {
                confirmationModal = (
                    <ConfirmationDialog
                        contentText={resources.inqAddComponentModalResources.lblMessage}
                        open={openConfirmationRemove}
                        primaryActionOnClick={this.onClickCancelRemoveComponet}
                        primaryActionText={resources.inqAddComponentModalResources.btnDecline}
                        secondaryActionOnClick={this.onClickRemoveComponent}
                        secondaryActionText={resources.inqAddComponentModalResources.btnAccept}
                        title={resources.inqAddComponentModalResources.lblConfirmationDialogTitle}
                    />
                );
            }
            contentPage = (
                <>
                    <AppSetupHandler
                        ...
                        layoutDescription={layoutDescription}
                        layoutName={layoutName}
                        resources={resources.inqSetupHandlerResources}
...
const InquirySetupViewWithLayout = withLayout(InquirySetupView);
// #endregion Component

// RenderDOM: Component
ReactDOM.render(<InquirySetupViewWithLayout />, document.getElementById('root'));