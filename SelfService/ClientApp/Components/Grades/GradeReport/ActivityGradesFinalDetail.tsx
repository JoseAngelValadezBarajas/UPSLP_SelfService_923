 ...
 * File: ActivityGradesFinalDetail.tsx
...
export interface IActivityGradesDetailProps {
    faculties?: string;
    finalDetails: IActivityGradesProgress[];
    lblYourFinalProgress: string;
    finalScore?: string;
    resources: IActivityGradesFinalDetailResProps;
}

export interface IActivityGradesFinalDetailResProps {
...
// #region Component
const ActivityGradesFinalDetail: React.FC<PropsWithStyles> = (props: PropsWithStyles): JSX.Element => {

    const {
        classes,
        finalDetails,
        finalScore,
        lblYourFinalProgress,
        resources
    } = props;
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={5} md={4} lg={2}>
                    <UpDownLabel
                        ...
                        textUp={finalScore ? finalScore + '%' : resources.lblNa}
                        withMarginTextUp
                    />
                </Grid>
            </Grid>
    ...
    const content: JSX.Element = (
        <Grid container spacing={3}>
            <Grid item xs>
                {finalDetails.map((m, i) => (
                    <React.Fragment key={`finalterm{m.description}_${i}`}>
                        <Grid container spacing={3}>
...
// Export: Component
export default withStyles(styles)(ActivityGradesFinalDetail);