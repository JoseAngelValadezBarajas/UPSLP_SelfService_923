// --------------------------------------------------------------------
// <copyright file="ApplicationSetupResources.cs" company="Ellucian">
...
{
    public class AppAddComponentModalResources
    {
    ...
    public class AppAddOptionsModalResources
    {
        public string BtnSave { get; set; }
    ...
    public class AppExtraComponentSetupResources
    {
    ...
    public class AppFieldGroupSetupResources
    {
        public string BtnSave { get; set; }
    ...
    public class ApplicationSetupResources : LayoutResources
    {
        public AppAddComponentModalResources appAddComponentModalResources { get; set; }
        public AppAddOptionsModalResources appAddOptionsModalResources { get; set; }
        public AppExtraComponentSetupResources appExtraComponentSetupResources { get; set; }
        public AppFieldGroupSetupResources appFieldGroupSetupResources { get; set; }
        public AppNameSetupResources appNameSetupResources { get; set; }
        public AppSendToModalResources appSendToModalResources { get; set; }
        public AppSetupHandlerResources appSetupHandlerResources { get; set; }
        public AppSetupStepModalResources appSetupStepModalResources { get; set; }
        public AppTextSetupResources appTextSetupResources { get; set; }
        public AppUserDefinedSetupResources appUserDefinedSetupResources { get; set; }
        public string LblHeaderTitle { get; set; }
        public string LblPageTitle { get; set; }
    }

    public class AppNameSetupResources
    {
        public string BtnSave { get; set; }
        public string LblDescription { get; set; }
    ...
    public class AppSendToModalResources
    {
        public string BtnSave { get; set; }
        public string LblSelect { get; set; }
    ...
    public class AppSetupHandlerResources
    {
        public string BtnSave { get; set; }
    ...
    public class AppSetupStepModalResources
    {
        public string BtnSave { get; set; }
        public string LblConfirmationDialog { get; set; }
    ...
    public class AppTextSetupResources
    {
    ...
    public class AppUserDefinedSetupResources
    {
